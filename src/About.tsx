  ...
  return (
    <div className="about">
      ...
      <div className="about-me">
        <p>
          🚀 Hi, I'm Abdellah, a software developer passionate about Flutter. I
          bring ideas to life through code, and dabble in 3D design. In my spare
          time, I turn my creative energy into game development 👾💻✨
        </p>
      </div>
